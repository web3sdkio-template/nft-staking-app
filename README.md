...
**Disclaimer**: This smart contract is not tested or audited by web3sdkio. It is not intended for production use cases.
...
```bash
npx web3sdkio create --template nft-staking-app
```
...
This provides us with a link to deploy the contract via the [web3sdkio dashboard](https://web3sdk.io/dashboard)

## Front-end Application

On the front-end, we connect to all three of our smart contracts and interact with them using web3sdkio's SDKs.

### Configuring the Web3sdkioProvider

We wrap our application in the `Web3sdkioProvider` component to access all of the React SDK's hooks and configure the network we want to support.
